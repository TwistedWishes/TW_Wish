...
import * as sty from "./PlasmicTextInput.module.css" // plasmic-import: T5OQ3DDo9hy/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg" // plasmic-import: ipUkTDoO7yD/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg" // plasmic-import: hY75ayaGijS/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__tvwWq)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ieIql)}
                role={"img"}
              />
            ),
