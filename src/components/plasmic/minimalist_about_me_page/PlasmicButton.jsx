...
import * as sty from "./PlasmicButton.module.css" // plasmic-import: JBOh-oHa-gy/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg" // plasmic-import: hY75ayaGijS/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4" // plasmic-import: D7K-_Ge4KXr/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__oFm7L)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__bbVft)}
                role={"img"}
              />
            ),
